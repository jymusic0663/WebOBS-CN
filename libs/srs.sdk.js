...
/* 格式化 WebRTC 发送端（RTCRtpSender）的编解码器，可选参数kind（audio/video）用于过滤。
- senders : RTCRtpSender 对象的数组
- kind : 可选参数，用于过滤音频或视频编解码器
...
if (typeof exports === "object" && typeof module === "object") {
  ...
  exports.SrsRtcPublisherAsync = SrsRtcPublisherAsync;
  exports.SrsRtcPlayerAsync = SrsRtcPlayerAsync;
  exports.SrsRtcWhipWhepAsync = SrsRtcWhipWhepAsync;
  exports.SrsRtcFormatSenders = SrsRtcFormatSenders;
  exports.SrsError = SrsError;
} else {
  window._SrsRtc = {
    SrsRtcPublisherAsync,
    SrsRtcPlayerAsync,
